...
export enum Action {
   ...
   * 动作--跳转主页面搜包
   */
  NOTIFICATION_LATER = 'com.ohos.updateapp.later',  //todo
 ...
 * 包名
 */
export const PACKAGE_NAME = 'com.ohos.updateapp';  //todo

/**
 * 主ability名
 */
export const MAIN_ABILITY_NAME = 'com.ohos.updateapp.MainAbility';  //todo